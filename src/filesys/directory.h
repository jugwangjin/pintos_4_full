...
bool fd_elem_isdir (struct dir *, char *name);
struct dir* find_dir (const char* name, char* fn_copy, struct dir* dir);
bool mkdir_by_name (char*, struct dir*);
bool isdir_by_name (struct  dir*, char*);

bool dir_is_empty (struct dir* dir);
bool dir_can_removed (struct dir* dir);
bool dir_is_opened (struct dir* dir);
